...
export default function StatsPage() {
  const [activeTab, setActiveTab] = useState<"runs" | "wickets" | "boundaries">("runs");
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        <Card>
          ...
          <div className="flex gap-2 justify-center flex-wrap">
            <Button
              variant={activeTab === "runs" ? "primary" : "secondary"}
              onClick={() => setActiveTab("runs")}
            >
              Most Runs
            </Button>
            <Button
              variant={activeTab === "wickets" ? "primary" : "secondary"}
              onClick={() => setActiveTab("wickets")}
            >
              Most Wickets
            </Button>
            <Button
              variant={activeTab === "boundaries" ? "primary" : "secondary"}
